...
| Người dùng | AI |
|------------|-----|
| *"Tiền điện tháng này của tôi bao nhiêu?"* | → Truy xuất hệ thống điện lực đã tích hợp<br />→ Trả về số tiền |
| *"Ok thanh toán đi."* | → Thanh toán qua ví liên kết (MetaMask / Credit Card / PayPal) |
...
1. **Tìm và đề xuất chuyến bay**  
   Từ các hãng đã tích hợp như Vietnam Airlines, Vietjet Air  
   → Gợi ý giờ bay  
   → Người dùng chọn  
   → Đặt và thanh toán  

2. **Đặt 2 chai rượu ngoại**  
   Ví dụ: Chivas Regal 18, Johnnie Walker Blue Label  
   Tìm từ các nhà phân phối đã listing trên hệ thống.  

3. **Đặt 20 nguyên liệu cho mâm cỗ cúng:**  
   Gà ta · Gạo nếp · Đậu xanh · Lá dong · Thịt ba chỉ · Giò lụa · Chả quế · Hành tím · Tỏi · Mắm · Muối · Đường · Nước mắm ngon · Hạt tiêu · Miến · Mộc nhĩ · Nấm hương · Trứng gà · Rau thơm · Trầu cau  
